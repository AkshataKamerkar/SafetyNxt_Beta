"""
Django settings for SafetyNxt project.
...
SECRET_KEY = 'django-insecure-aa+^6n9b)3v&2-f$!qwxu_&2eiv(13yshpc7^w2dp*5u(=^r2#'
...
WSGI_APPLICATION = 'SafetyNxt.wsgi.application'
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = os.environ["test_account"]
EMAIL_HOST_PASSWORD = os.environ["test_password"]
